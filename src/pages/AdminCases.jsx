    ...
    <div className="flex flex-col min-h-screen bg-[#f4f7fe] font-sans relative">
      ...
      >
        ...
        <div
          ...
          style={{ width: 300, justifyContent: "flex-end" }}
        >
        ...
        {!loading && !error && (
          <>
            ...
            >
              ...
              <div
                className="flex flex-col border-b border-gray-100 bg-white"
                style={{ padding: "24px 32px" }}
              >
                <div className="flex items-end justify-between">
                  <div>
                    <h2
                      className="text-[19px] font-extrabold text-gray-900"
                ...
                {/* Filter Row */}
                <div
                  className={`overflow-hidden transition-all duration-300 ease-in-out ${showFilters ? "max-h-[100px] mt-6 opacity-100" : "max-h-0 mt-0 opacity-0"}`}
                >
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-[#f8fafc] border-b border-gray-100">
                    <th
                      className="text-left text-[12px] font-bold text-gray-500 uppercase tracking-wider"
                      style={{ padding: "16px 32px", width: "8%" }}
                    >
                      ID
                    </th>
                    <th
                      className="text-left text-[12px] font-bold text-gray-500 uppercase tracking-wider"
                      style={{ padding: "16px 32px", width: "30%" }}
                    >
                      Опис и Категорија
                    </th>
                    <th
                      className="text-left text-[12px] font-bold text-gray-500 uppercase tracking-wider"
                      style={{ padding: "16px 32px", width: "18%" }}
                    >
                      Институција
                    </th>
                    <th
                      className="text-left text-[12px] font-bold text-gray-500 uppercase tracking-wider"
                      style={{ padding: "16px 32px", width: "14%" }}
                    >
                      Статус
                    </th>
                    <th
                      className="text-left text-[12px] font-bold text-gray-500 uppercase tracking-wider"
                      style={{ padding: "16px 32px", width: "15%" }}
                    >
                      Координати
                    </th>
                    <th
                      className="text-right text-[12px] font-bold text-gray-500 uppercase tracking-wider"
                      style={{ padding: "16px 32px", width: "15%" }}
                    >
                      Акции
                    </th>
                    ...
                    .map((caseItem, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td
                            style={{ padding: "24px 32px", paddingRight: 20 }}
                          >
                            <p className="text-[14px] font-bold text-gray-900 group-hover:text-blue-600 transition-colors line-clamp-2">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-[#e0f2fe] rounded-[24px] p-8 relative overflow-hidden border border-blue-100 flex flex-col">
                    ...
                    <div className="relative z-10 flex flex-col flex-1">
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-[16px] font-extrabold text-[#0369a1]">
...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute left-0 top-0 bottom-0 w-1.5 ${accentColor || "bg-blue-500"} rounded-l-2xl`}
      />

      {/* Subtle decorative circle */}
      <div
        className={`absolute -right-6 -bottom-6 w-28 h-28 rounded-full opacity-[0.04] ${accentColor || "bg-blue-500"} group-hover:opacity-[0.07] transition-opacity duration-500`}
      />
      ...
      {/* MIDDLE: Big number */}
      <p className="text-[36px] font-extrabold text-gray-900 leading-none tracking-tight">
        {value}
      </p>
      ...
      <div>
        ...
        <p className={`text-[12px] font-medium mt-1 ${subLabelColor}`}>
          {subLabel}
        </p>
      </div>
    </div>
